# Ported from ai-monitoring-core/chatgptarchive.py @ 703acc93 (master) during the conversation-analysis
# consolidation (2026-09-12). See docs/PROVENANCE.md.
# Changes vs original: verbatim; og twin chatgptarchive-og/chatgptarchive.py is byte-identical except trailing newline
