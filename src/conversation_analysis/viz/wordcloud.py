# Ported from ai-conversation-analyzer/gptwordcloud-2.py @ a616deaf (master) during the conversation-analysis
# consolidation (2026-09-12). See docs/PROVENANCE.md.
# Changes vs original: newer of the wordcloud pair (stop-word filtering, 1000 words, sentiment); hardcoded path -> env/relative
